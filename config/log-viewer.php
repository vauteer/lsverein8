...
return [
    ...
    */
    ...
    'api_stateful_domains' => is_string($apiStatefulDomains = env('LOG_VIEWER_API_STATEFUL_DOMAINS')) ? explode(',', $apiStatefulDomains) : null,
    ...
    */
    ...
    'include_files' => [
        // Only this application's own log, as in lswatter4. The server's logs
        // (php-fpm, nginx, ...) live outside the project and usually aren't
        // readable by the web user anyway, so listing them here only produces
        // entries that fail to open. This also hides storage/logs/browser.log.
        'laravel*.log',
    ],
